...
<body class="bg-gray-100 p-8">
    ...
    <form action="<?= base_url('sarl/contacts/store') ?>" method="post" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md max-w-lg">
        <div class="mb-4">
            <label for="adresse" class="block font-semibold mb-2">Adresse</label>
            <textarea name="adresse" id="adresse" required class="w-full border px-4 py-2 rounded"></textarea>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="telf" id="telf" required class="w-full border px-4 py-2 rounded">
        </div>
